...
import 'package:clean_arch_dart/app/modules/home/domain/repositories/update_user_repository.dart';
...
final $UpdateUserUseCaseImpl = Bind.singleton((i) => UpdateUserUseCaseImpl(i()));
